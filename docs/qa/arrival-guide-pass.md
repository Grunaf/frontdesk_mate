...
| --- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---- | ---- | ----- |
| 1   | Open check-in URL → enter valid 6-digit PIN                                                                  | Redirect to `/welcome` (settlement step); no stuck spinner >10s                                                             | ☐    | ☐    |       |
...
| 5   | **Without** PIN (incognito): open `/en/welcome?step=arrival` or tap locked **Arrival** / **Settlement** chip | Check-in required bottom sheet opens; primary actions readable; no dead taps                                                | ☐    | ☐    |       |
