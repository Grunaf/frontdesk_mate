...
- [ ] **Reception flow** — open `{slug}.reception.localhost:3000/login` (prod: `{slug}.reception.domain`), sign in with desk PIN, land on desk (not landing). Create new PIN, old PIN from `e2e/env.local` still works
