...
describe('resolvePartyBookingBlockers', () => {
  const stays = [
    ...
    { id: 'b', passport_checked_at: '2026-01-01', desk_checked_in_at: null },
  ...
  it('returns null when all ready', () => {
    expect(
      resolvePartyBookingBlockers({
        partyStays: [
          { id: 'a', passport_checked_at: 'x', desk_checked_in_at: null },
          { id: 'b', passport_checked_at: 'x', desk_checked_in_at: null },
        ],
