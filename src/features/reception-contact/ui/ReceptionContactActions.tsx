...
import { Button, ExternalServiceButton, ExternalServiceTouchLink, Icon, TouchLink } from '@/shared/ui';
...
export function ReceptionContactActions({
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      {contact.telHref ? (
        <Button asChild size={callButtonSize} variant="outline" className="w-full">
          <a
