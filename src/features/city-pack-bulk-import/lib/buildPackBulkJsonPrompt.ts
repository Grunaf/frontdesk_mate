...
Convert the research into one pack JSON object for the hostel admin app.`;
  ...
  return [
    ...
    'taxi.taxiPickupPoint: short hub line for guest zone A (desk/stand); must align with WhatsApp pickup text.',
    'taxi.tips: max 2 — index 0 = where at this hub; index 1 = deal before boarding (meter/fixed/scam). No prices, no call/book taxi wording.',
    ...
    'Fill transitScheduleAdvice/transitTicketPayment from research; one line each, max 15 words, non-generic, no duplication with tips.',
