...
export const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer: "Вам не нужно никуда ходить. Хостел берет на себя официальную регистрацию всех гостей в полицейской и туристической системе Боснии и Герцеговины в течение 24 часов с момента вашего заезда."
  }
];
