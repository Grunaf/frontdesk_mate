  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        line: "gap-1 bg-muted/40 text-foreground group-data-horizontal/tabs:h-8",
        category:
          "bg-muted group-data-horizontal/tabs:h-auto group-data-horizontal/tabs:min-h-11",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=category]/tabs-list:!h-auto group-data-[variant=category]/tabs-list:min-h-11 group-data-[variant=category]/tabs-list:whitespace-normal",
