...
export function mapReservationGrantToStayRecord(
  ...
  return {
    ...
    passport_checked_at: reservation.passport_checked_at
      ...
      : null,
    bed_unlocked_at: reservation.bed_unlocked_at ? String(reservation.bed_unlocked_at) : null,
